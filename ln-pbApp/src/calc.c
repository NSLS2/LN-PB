...
/* .............................................*/
/*                                              */
/* JULY 16, 2021: C. Marques: I downsized       */
/* the RAM by a factor of 4 (128*1024*1024 bytes*/
/* = 134217728 = 0x08000000 bytes =             */
/* =  67108864 = 0x04000000 short values        */
/*                                              */ 
/* A wf[0]  = input wf of 67108864 short vals	*/
...
register
    ...
    length =  nlm[0];			/*  67 108 864 */
    nd = (int)floor((double)length/16); /*   4 194 304 */
...
unsigned
    ...
    */
    *(double *)prec->vala = (double)trigaddr;
    prec->neva=1;
    printf("TrigA=%d\n", trigaddr );
    
    *(double *)prec->valb = (double)trigaddrOdd;
    prec->nevb=1;
    return 0;
}
