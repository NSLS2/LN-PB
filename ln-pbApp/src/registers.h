...
//#define	OPAL_KELLY_BIT_FILENAME	"llrf_xem.bit"
#define	OPAL_KELLY_BIT_FILENAME	"llrf_xem20120626Rev87_w_tuner.bit"
...
#define	OPAL_KELLY_SERIAL_NO	"tgcePQOiXe"
...
/* JULY 16, 2021 									*/
/*											*/
#define	CIRC_BYTES	  0x08000000 /*128M bytes     	134 217 728			*/
#define	CIRC_SHORTS       0x04000000 /* 64M short vals	 67 108 864			*/
#define	CIRC_INT32        0x02000000 /* 32M int   vals					*/
#define	CIRC_DBL          0x01000000 /* 16M dbl   vals					*/
/*^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^*/
